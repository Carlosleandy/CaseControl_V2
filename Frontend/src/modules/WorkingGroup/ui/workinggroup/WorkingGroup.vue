<script setup lang="ts">
    ...
    import type { WorkingGroup, WorkingGroupRow } from '../../domain/model/workinggroup'
    import ConfirmPopup from 'primevue/confirmpopup'
    import WorkingGroupForm from './Form.vue'
    ...
    const openFormDialog = (record: WorkingGroup | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteWorkingGroupById(id: number): Promise<void> {
