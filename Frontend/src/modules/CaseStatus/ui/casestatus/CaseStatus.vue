<script setup lang="ts">
    ...
    import type { CaseStatus, CaseStatusRow } from '../../domain/model/casestatus'
    import ConfirmPopup from 'primevue/confirmpopup'
    import CaseStatusForm from './Form.vue'
    ...
    const openFormDialog = (record: CaseStatus | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteCaseStatusById(id: number): Promise<void> {
        ...
        <template #desktop>
            <div class="card">
                ...
                >
                    ...
                    <Column field="name" :header="$t('Descripción')" style="width: 70%"></Column>
                    <Column field="percent" :header="$t('Porciento')" style="width: 10%" ></Column>
