<script setup lang="ts">
    ...
    import type { Evidence, EvidenceRow } from '../../domain/model/evidence'
    import ConfirmPopup from 'primevue/confirmpopup'
    import EvidenceForm from './Form.vue'
    ...
    const openFormDialog = (record: Evidence | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteEvidenceById(id: number): Promise<void> {
