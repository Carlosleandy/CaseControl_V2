<script setup lang="ts">
    ...
    import type { CaseAssignment, CaseAssignmentRow } from '../../domain/model/caseassignment'
    import ConfirmPopup from 'primevue/confirmpopup'
    import CaseAssignmentForm from './Form.vue'
    ...
    const openFormDialog = (record: CaseAssignment | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteCaseAssignmentById(id: number): Promise<void> {
