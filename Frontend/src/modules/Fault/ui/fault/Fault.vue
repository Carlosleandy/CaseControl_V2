<script setup lang="ts">
    ...
    import type { Fault, FaultRow } from '../../domain/model/fault'
    import ConfirmPopup from 'primevue/confirmpopup'
    import FaultForm from './Form.vue'
    ...
    const openFormDialog = (record: Fault | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteFaultById(id: number): Promise<void> {
        ...
        <template #desktop>
            <div class="card">
                ...
                >
                    ...
                    <Column field="faultType.name" :header="$t('Tipo Falta')" style="width: 10%"></Column>
