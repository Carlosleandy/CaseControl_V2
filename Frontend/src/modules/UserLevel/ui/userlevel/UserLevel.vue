<script setup lang="ts">
    ...
    import type { UserLevel, UserLevelRow } from '../../domain/model/userlevel'
    import ConfirmPopup from 'primevue/confirmpopup'
    import UserLevelForm from './Form.vue'
    ...
    const openFormDialog = (record: UserLevel | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteUserLevelById(id: number): Promise<void> {
        ...
        <template #desktop>
            <div class="card">
                ...
                >
                    ...
                    <Column field="role.name" :header="$t('Rol')" style="width: 20%"></Column>
