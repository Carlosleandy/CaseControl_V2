<script setup lang="ts">
    ...
    import { useFaultLinked } from '../../composable/faultlinkedComposable'
    import type { FaultLinked, FaultLinkedRow } from '../../domain/model/faultlinked'
    import ConfirmPopup from 'primevue/confirmpopup'
    import FaultLinkedForm from './Form.vue'
    ...
    const {
        ...
        faultlinkedRepository: props.faultlinkedRepository
    });
    ...
    const openFormDialog = (record: FaultLinked | null, isCloning = false) => {
