...
using CaseControl.Token.Interfaces;
...
namespace CaseControl.Token.Services
{
    public class TokenService : IToken
    {
        ...
        public TokenService(IOptions<JWTSettings> jwtSettings, IUsers users, IAuditAreas auditAreas)
        {
        ...
        public async Task<TokenResponse> GenerateJwtToken(User user) //Recibe un objeto con los datos del usuario autenticado.
        {
            ...
            var accesos = await _users.GetAccessByUserAsync(usuario);
