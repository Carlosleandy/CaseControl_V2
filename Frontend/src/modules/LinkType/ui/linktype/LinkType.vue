<script setup lang="ts">
    ...
    import type { LinkType, LinkTypeRow } from '../../domain/model/linktype'
    import ConfirmPopup from 'primevue/confirmpopup'
    import LinkTypeForm from './Form.vue'
    ...
    const openFormDialog = (record: LinkType | null, isCloning = false) => {
        recordId.value = record ? record.id : 0;
        showDialog.value = true;
        isCloningRecord.value = isCloning;
    }

    async function deleteLinkTypeById(id: number): Promise<void> {
