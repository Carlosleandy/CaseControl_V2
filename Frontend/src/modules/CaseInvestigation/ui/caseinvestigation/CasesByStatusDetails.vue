...
const loadInitialData = () => {
  if (props?.statusId) {
    getCasesByStatus(props.statusId);
    };
};
 
 const DownloadReportPDF = async () => {
        await generatePDFCasesByStatus(props?.statusId);  
    }
    ...
    <ContentWrapper @onContentFinish="getAllRecords" :searching="loadingRecords">        
        ...
        <template #desktop>
            <div class="card">
                ...
                <DataTable :value="casesbystatus.data" 
                    size="small"
                    scrollable
                ...
                >
                    ...
                    <Column field="caseType.name" :header="$t('Tipo Caso')" style="width: 15%"></Column>
                    <Column field="user.employee.nombre_Completo" :header="$t('Usuario Asignado')" style="width: 20%"></Column>
                    <Column field="amountDetected" :header="$t('Monto Detectado')" style="width: 5%"></Column>
                    <Column field="amountInvestigated" :header="$t('Monto Investigado')" style="width: 5%"></Column>
                    <Column field="amountRecovered" :header="$t('Monto Recuperado')" style="width: 5%"></Column>
                    <Column field="amountLost" :header="$t('Monto Pérdida')" style="width: 5%"></Column>
