...
namespace CaseControl.Api.Migrations
{
    ...
    [Migration("20250601154214_addGerencias")]
    partial class addGerencias
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaseControl.Domain.Entities.Gerencia", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaseControl.Domain.Entities.Case", b =>
                {
                    ...
                    b.HasOne("CaseControl.Domain.Entities.Gerencia", "Gerencia")
                        .WithMany("Cases")
