<script setup lang="ts">
    import type { RecommendationFilter } from "../../domain/model/recommendation"
    import { ref } from 'vue'
    ...
    const filter = ref<RecommendationFilter>({...props.modelValue});

    const clearFilter = () => {
        filter.value = {} as RecommendationFilter;
