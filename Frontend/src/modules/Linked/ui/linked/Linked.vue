<script setup lang="ts">
    ...
    import type { Linked, LinkedRow } from '../../domain/model/linked'
    import ConfirmPopup from 'primevue/confirmpopup'
    import LinkedForm from './Form.vue'
    ...
    const openFormDialog = (record: Linked | null, isCloning = false) => {
        ...
        <template #desktop>
            <div class="card">
                ...
                >
                    ...
                    <Column field="fullName" :header="$t('Descripción')" style="width: 70%"></Column>
